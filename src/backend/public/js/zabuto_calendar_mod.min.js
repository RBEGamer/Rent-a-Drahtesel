...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $currMonthLabel = $('<span id=>' + "<input type='hidden' name='kal_current_month' value='"+(month+1)+"' />"+monthLabels[month] + ' ' + year + "<input type='hidden' name='kal_current_year' value='"+year+"' /></span>");
        ...
        function appendDaysOfMonth($calendarElement, $tableObj, year, month) {
            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                var $dowRow = $('<tr class="calendar-dow event"></tr>');
